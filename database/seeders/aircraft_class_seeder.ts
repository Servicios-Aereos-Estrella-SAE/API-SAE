...
export default class extends BaseSeeder {
  async run() {
    ...
    await AircraftClass.createMany([
      {
        aircraftClassBanner:
          'https://sfo2.digitaloceanspaces.com/public-cdn-devsupernova/sae-rh-system/files/T1723132408881R05663187364.jpg',
        ...
        aircraftClassSlug: 'compact-light-jet',
      ...
      },
      {
        ...
        aircraftClassSlug: 'super-midsize-jet',
        aircraftClassStatus: 1,
      },
      {
        aircraftClassBanner:
      ...
      },
      {
        ...
        aircraftClassSlug: 'ultra-long-range-jet',
        aircraftClassStatus: 1,
      },
    ])
  }
