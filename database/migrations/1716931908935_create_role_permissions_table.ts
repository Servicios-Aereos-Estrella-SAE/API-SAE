...
export default class extends BaseSchema {
  ...
  async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.timestamp('role_permission_created_at').notNullable()
      table.timestamp('role_permission_updated_at').nullable()
      table.timestamp('role_permission_deleted_at').nullable()
    })
  }
